...
export const config = {
  ...
  lcVisibleReconcileMs: Math.max(2000, int(process.env.LIVECHAT_VISIBLE_RECONCILE_MS, 5000)),
  lcVisibleReconcileBatch: Math.min(500, Math.max(1, int(process.env.LIVECHAT_VISIBLE_RECONCILE_BATCH, 50))),
  lcVisibleReconcileConcurrency: Math.min(16, Math.max(1, int(process.env.LIVECHAT_VISIBLE_RECONCILE_CONCURRENCY, 5))),
